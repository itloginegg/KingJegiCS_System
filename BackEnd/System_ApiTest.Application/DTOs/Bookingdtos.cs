...
namespace System_ApiTest.Application.DTOs
{
    ...
    public static class EventDetailRules
    {
        ...
        public static bool UsesCouple(EventType? t) => t == System_ApiTest.Domain.Entities.EventType.Wedding;

        public static bool UsesCelebrant(EventType? t) =>
            t is System_ApiTest.Domain.Entities.EventType.Birthday or System_ApiTest.Domain.Entities.EventType.Debut;

        public static bool UsesEventName(EventType? t) =>
            t is System_ApiTest.Domain.Entities.EventType.Corporate or System_ApiTest.Domain.Entities.EventType.Others;
