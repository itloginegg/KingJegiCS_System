...
namespace System_ApiTest.Infrastructure.Migrations
{
    ...
    [Migration("20260829142317_AddSupportDrafts")]
    partial class AddSupportDrafts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.BookingResourceAllocation", b =>
                {
                    ...
                    b.ToTable("BookingResourceAllocations");
                });

            modelBuilder.Entity("System_ApiTest.Domain.Entities.BookingResourceAllocationLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AllocationId", "RentalItemId")
                        .IsUnique()
                        .HasFilter("[RentalItemId] IS NOT NULL");

                    b.HasIndex("AllocationId", "ServiceItemId")
                        .IsUnique()
                        .HasFilter("[ServiceItemId] IS NOT NULL");

                    b.ToTable("BookingResourceAllocationLines", t =>
                        {
                            t.HasCheckConstraint("CK_BookingResourceAllocationLine_OneTarget", "([RentalItemId] IS NOT NULL AND [ServiceItemId] IS NULL) OR ([RentalItemId] IS NULL AND [ServiceItemId] IS NOT NULL)");

                            t.HasCheckConstraint("CK_BookingResourceAllocationLine_QuantityInRange", "[Quantity] BETWEEN 1 AND 100000");
                        });
                });
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Galleryimage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Menupackageimage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Supportdraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.BookingResourceAllocationLine", b =>
                {
                    b.HasOne("System_ApiTest.Domain.Entities.BookingResourceAllocation", "Allocation")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Galleryimage", b =>
                {
                    b.HasOne("System_ApiTest.Domain.Entities.Admin", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Supportdraft", b =>
                {
                    ...
                    b.HasOne("System_ApiTest.Domain.Entities.Supportmessage", "TriggerMessage")
                        .WithMany()
