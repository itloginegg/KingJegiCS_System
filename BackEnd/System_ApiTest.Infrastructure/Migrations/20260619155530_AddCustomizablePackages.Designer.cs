...
namespace System_ApiTest.Infrastructure.Migrations
{
    ...
    [Migration("20260619155530_AddCustomizablePackages")]
    partial class AddCustomizablePackages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Booking", b =>
                {
                    ...
                    b.ToTable("Bookings", t =>
                        {
                            t.HasCheckConstraint("CK_Booking_EndAfterStart", "([EndDate] > [EventDate]) OR ([EndDate] = [EventDate] AND [EndTime] > [StartTime])");

                            t.HasCheckConstraint("CK_Booking_EndDateNotBefore", "[EndDate] >= [EventDate]");

                            t.HasCheckConstraint("CK_Booking_GuestCountPositive", "[GuestCount] > 0");
                        });
                });
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.Menuitem", b =>
                {
                    ...
                    b.ToTable("MenuItems", t =>
                        {
                            t.HasCheckConstraint("CK_MenuItem_PricedIfStandalone", "([MenuPackageId] IS NOT NULL) OR ([CostPerPortion] IS NOT NULL)");
                        });
                });
                    ...
                    b.ToTable("Services", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Service_UnitCostNonNeg", "[UnitCost] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("System_ApiTest.Domain.Entities.SlotCategory", b =>
                {
                    ...
                    b.ToTable("SlotCategories", t =>
                        {
                            t.HasCheckConstraint("CK_SlotCategory_ExactlyOne", "([ItemCategory] IS NOT NULL AND [CourseCategory] IS NULL) OR ([ItemCategory] IS NULL AND [CourseCategory] IS NOT NULL)");
                        });
                });
